...
namespace NzbDrone.Core.Test.ImportListTests
{
    public class ImportListSyncServiceFixture : CoreTest<ImportListSyncService>
    {
        ...
        {
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(It.Is<List<Series>>(x => x.Count == expectedSeriesCount && x.All(series => series.Tags.Contains(expectedTagId))), true), Times.Once());
        }
        ...
        public void should_not_clean_library_if_lists_have_not_removed_any_items()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(It.IsAny<List<Series>>(), true), Times.Never());
        }
        ...
        public void should_not_clean_library_if_config_value_disable()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(new List<Series>(), true), Times.Never());
        }
        ...
        public void should_log_only_on_clean_library_if_config_value_logonly()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(new List<Series>(), true), Times.Once());
        }
        ...
        public void should_unmonitor_on_clean_library_if_config_value_keepAndUnmonitor()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(It.Is<List<Series>>(s => s.Count == monitored && s.All(m => !m.Monitored)), true), Times.Once());
        }
        ...
        public void should_not_clean_on_clean_library_if_tvdb_match()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(It.Is<List<Series>>(s => s.Count == 1 && s.All(m => !m.Monitored)), true), Times.Once());
        }
        ...
        public void should_not_clean_if_list_failures()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(It.IsAny<List<Series>>(), It.IsAny<bool>()), Times.Never());
