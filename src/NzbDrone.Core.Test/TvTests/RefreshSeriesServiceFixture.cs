...
namespace NzbDrone.Core.Test.TvTests
{
    ...
    public class RefreshSeriesServiceFixture : CoreTest<RefreshSeriesService>
    {
        ...
        public void should_monitor_new_seasons_automatically_if_monitor_new_items_is_all()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.Seasons.Count == 2 && s.Seasons.Single(season => season.SeasonNumber == 2).Monitored == true), It.IsAny<bool>(), It.IsAny<bool>()));
        }
        ...
        public void should_not_monitor_new_seasons_automatically_if_monitor_new_items_is_none()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.Seasons.Count == 2 && s.Seasons.Single(season => season.SeasonNumber == 2).Monitored == false), It.IsAny<bool>(), It.IsAny<bool>()));
        }
        ...
        public void should_not_monitor_new_special_season_automatically()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.Seasons.Count == 2 && s.Seasons.Single(season => season.SeasonNumber == 0).Monitored == false), It.IsAny<bool>(), It.IsAny<bool>()));
        }
        ...
        public void should_update_tvrage_id_if_changed()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.TvRageId == newSeriesInfo.TvRageId), It.IsAny<bool>(), It.IsAny<bool>()));
        }
        ...
        public void should_update_tvmaze_id_if_changed()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.TvMazeId == newSeriesInfo.TvMazeId), It.IsAny<bool>(), It.IsAny<bool>()));
        }
        ...
        public void should_update_tmdb_id_if_changed()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.TmdbId == newSeriesInfo.TmdbId), It.IsAny<bool>(), It.IsAny<bool>()));
        }
        ...
        public void should_log_error_if_tvdb_id_not_found()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.Status == SeriesStatusType.Deleted), It.IsAny<bool>(), It.IsAny<bool>()), Times.Once());
        ...
        public void should_update_if_tvdb_id_changed()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.TvdbId == newSeriesInfo.TvdbId), It.IsAny<bool>(), It.IsAny<bool>()));
        ...
        public void should_not_throw_if_duplicate_season_is_in_existing_info()
        {
            ...
            Mocker.GetMock<ISeriesService>()
                  .Verify(v => v.UpdateSeriesMetadata(It.Is<Series>(s => s.Seasons.Count == 2), It.IsAny<bool>(), It.IsAny<bool>()));
        }
